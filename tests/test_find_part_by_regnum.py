...
def test_incorrect_regnum(driver):
    ...
    base_page.fill_form_regnum(uncorrect_regnum, uncorrect_regreg)
...
def test_correct_regnum(driver):
    ...
    base_page.fill_form_regnum(regnum, regreg)
    base_page.check_added_message_text_is("Отлично! Автомобиль добавлен")
